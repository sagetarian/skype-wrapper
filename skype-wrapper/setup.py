...
setup(name='skype-wrapper',
      ...
      data_files=[('share/glib-2.0/schemas', ['data/schemas/apps.skype-wrapper.gschema.xml']),
        ...
        ('share/skype-wrapper', ['src/helpers.py', 'src/indicator-applet-skype','src/indicator-applet-skype.py','src/postinst.py','src/settings.py','src/shared.py','src/skype-wrapper.py','src/unitylauncher.py','src/uisettings.py','src/uninstallsni.py']),
